                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('dana.destroy', $item->id) }}" method="POST">
                                                            @if (Auth::user()->role == 'Bendahara')
                                                                <a href="{{ route('dana.edit', $item->id) }}" class="btn btn-info" title="Edit"><span class="fas fa-edit"></span></a>
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            @else
                                                                <a class="btn btn-primary" href="{{ route('dana.show', $item->id) }}" title="Detail"><i class="fas fa-info"></i></a>
                                                            @endif
                                                        </form>
                                                    </td>
                                                </tr>
