                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 @error('people_id') is-invalid @enderror" name="people_id" required>
                                <option disabled hidden value="">Silahkan Pilih Warga</option>
                                @foreach ($peoples as $people)
                                    <option value="{{ $people->id }}" @if ($user->people_id == $people->id) selected @endif>{{ $people->name }}</option>
                                @endforeach
                            </select>
                            @error('people_id')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control required" name="role" required>
                                <option disabled hidden value="">Silahkan Pilih</option>
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" class="form-control @error('email') is-invalid @enderror" required name="email" value="{{ $user->email }}" placeholder="Masukkan Email">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
